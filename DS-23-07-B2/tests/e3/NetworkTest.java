...
class NetworkTest {
    @Test
    void Mapa(){
        //inicamos el tipo de working manager
        Map mapa= new Map();
        //creamos una network
        Network network=new Network();
        //seteamos el tipo de workingmanager a hashmapa
        network.setNetworkManager(mapa);
        //comprobamos que el set funciona
        assertEquals(mapa,network.getNetworkManager());
        //iniciamos las lista  de intereses y de usuarios(Strings)
